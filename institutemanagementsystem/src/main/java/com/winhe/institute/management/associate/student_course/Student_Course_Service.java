...
public class Student_Course_Service {
	...
	public JsonWrapper getAllStudentCourse() {
		...
		JsonWrapper data = new JsonWrapper("STUDENTCOURSE200", "List of All the Student Course Entires",
				student_Course_Repository.findAll());
	...
	public JsonWrapper addStudentCourse(Student_Course student_Course) {
		...
		JsonWrapper data = new JsonWrapper("STUDENTCOURSE200", "Student Course Entry  Successfully Added",
				student_Course);
	...
	public JsonWrapper updateStudentCourse(Long id, Student_Course student_Course) {
		...
		JsonWrapper data = new JsonWrapper("STUDENTCOURSE200", "Student Course Entry  Successfully Updated",
				student_Course);
